...
<template>
    ...
    <form action=""> 
        <div class="fill">
<p class="fillp">主题&emsp;：    <select v-model="theme">
        <option value="" disabled></option>
        <option value="首课提醒">首课提醒</option>
        <option value="首课再次提醒">首课再次提醒</option>
        <option value="旷课提醒">旷课提醒</option>
        <option value="升班提示">升班提示</option>
    </select> </p>
...
<p class="fillp">状态&emsp;：  &nbsp;&nbsp; <select  style="width:200px" v-model="state">
 ...
 <div class="search">
  ...
  <div class="message">
    ...
    <el-table-column prop="executor" label="主教" width="80" />
        ...
        <div class="content">
            ...
            <div class="conbuttom">
              <span>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</span>
                <!-- <span>{{info.address}}&emsp;&emsp;</span> -->
                <span>{{info.old}}&emsp;&emsp;</span>
                <span>{{info.classstar}}&emsp;&emsp;</span>
                <span>{{info.classend}}&emsp;&emsp;</span>
                <span>{{info.lastexercise}}&emsp;&emsp;</span>
